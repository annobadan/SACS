...
###' 
###' - FEP Students by Grade & Language: 1999-2017 
###' 
###' fluent-English-proficient (FEP) students by grade, language, and school
###' 
###' 
###' 20181020 JoonHo Lee 
###' 
...
for (i in 1:length(years)) {
  ...
  ### Get file name
  filename <- paste0("fepsch", year_num)
  ...
  if (year_num %in% c(sprintf("%02d", 99), sprintf("%02d",seq(0, 8)))) {
  ...
  } else if (year_num %in% sprintf("%02d",seq(9, 17))){
