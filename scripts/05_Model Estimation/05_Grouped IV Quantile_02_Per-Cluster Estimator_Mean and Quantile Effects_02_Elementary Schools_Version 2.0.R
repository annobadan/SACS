...
###' ELEMENTARY SCHOOLS: Exclude subjects other than Self-Contained Classes for now

df_y$y_name
to_exclude <- c("ELA", "Math", "_Social", "_Science", "FoLan", 
                "_CTE", "Other", "Art", "PE", 
                "Apprvd", "AG", "AP")
...
for (i in 34:length(y_names_vec)){
