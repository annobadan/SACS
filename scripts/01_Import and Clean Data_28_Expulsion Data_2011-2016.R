...
for (i in 1:length(years)) {
  ...
  ### Assign filename
  filename <- paste0("exp", year_num, sprintf("%02d", as.numeric(year_num) + 1))
  ...
  names(df)
  to_numeric <- c("Enrollment_Cum", "Total_Exps", "Rate_Exps", 
