...
for (i in seq_along(years)) {
  ...
  tbl_demo <- tag_ID_miss_dups(df_demo, 
                               match_key = c("CountyCode", "DistrictCode", "RecID"))
  ...
  tbl_fte_sch <- tag_ID_miss_dups(df_fte, 
                                  match_key = c("CountyCode", "DistrictCode", 
                                                "SchoolCode", "RecID"))
  ...
  tabdf(df_fte_duplicates_district, N) # duplicates within district
  
  
  tbl_fte_dist <- tag_ID_miss_dups(df_fte, 
                                   match_key = c("CountyCode", "DistrictCode", 
                                                 "RecID"))
  ...
  ###' 
  ###' This is possible because "Staff Demography" has no duplicates 
  ...
  df_demo_fte <- df_fte %>%
    full_join_track(df_demo, by = keys)
